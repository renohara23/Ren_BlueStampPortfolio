...
## Challenges
A challenge I had in completeing my starter project was the soldering. Before coming to BlueStamp I've never done soldering before, so initially I had a very difficult time soldering the components together. For example, I would either over solder or undersolder the wires to the circuit board. However, I was able to overcome this challenge by getting advice from my instructors as well as from Youtube. I learned that when soldering, having less is better than having more. Once I understood that, I had a easier time soldering the pieces together to create the retro arcade console. 
